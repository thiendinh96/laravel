								...
								<table class="table table-bordered" style="margin-top:20px;">
									...
									@foreach ($products as $row)
										...
										<td>{{$row->id}}</td>
											<td>
												<div class="row">
												<div class="col-md-3"><img src="/admins/img/{{$row->img}}" alt="Áo đẹp" width="100px" class="thumbnail"></div>
													<div class="col-md-9">
										...
										<td>{{$row->category->name}}</td>
											...
											<a onclick="return Del_Prd('{{$row->code}}')" href="/admin/product/del/{{$row->id}}" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
