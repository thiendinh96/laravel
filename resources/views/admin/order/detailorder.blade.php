...
@section('content')
					...
					<div class="panel-body">
						<div class="bootstrap-table">
							<div class="table-responsive">
								...
								<a onclick="return processed()" class="btn btn-success" href="/admin/order/paid/{{$order->id}}" role="button">Đã xử lý</a>
								</div>
							</div>
						</div>
	...
	<script>
		function processed(){
		return confirm("Đơn hàng sau khi xử lý sẽ được tính vào phần doanh thu");
		}
	</script>
